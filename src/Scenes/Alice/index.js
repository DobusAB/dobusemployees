...
import Memories from '../../Components/FirstMemoryAlice';
...
class Alice extends Component {
    ...
    render() {
        ...
        //let shortMemory = '"När mamma skulle försöka få mig att klippa gräsmattan med vår Husqvarna-gräsklippare, låt oss säga att det inte gick så bra med en bångstyrig 13-åring".';
        let shortMemory = '"Utsätt dig för möjligheten att ha tur, man vet aldrig hur bra det kan bli."';
         let longMemory = (
            <div> <a href="mailto:alice@dobus.se">alice@dobus.se</a> / <a href="tel:0708868608">070 886 86 08</a> </div>
        )
